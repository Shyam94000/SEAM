...
`;function Jn(t,e,n){switch(n){case"bottom-left":return e?Hn:_n;case"bottom-right":return e?Bn:kn;case"down":return t?e?Yn:Tn:e?Fn:Pn;case"left":return t?e?Xn:jn:e?qn:dt;case"right":return t?e?Vn:En:e?Gn:Cn;case"top-left":return e?Un:Mn;case"top-right":return e?Kn:Ln;case"up":return t?e?Zn:zn:e?Qn:Rn;default:return e?An:xn}}const de=t=>{const{big:e=!1,direction:n,reverse:i=!1,...r}=t,a=D.useMemo(()=>Jn(e,i,n),[e,n,i]);return A(qt,{keyframes:a,...r})};d`
  from {
